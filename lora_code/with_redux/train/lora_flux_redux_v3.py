#!/usr/bin/env python3
"""
Train LoRA on FLUX with Redux image conditioning - V3.
Uses noise_scheduler.sigmas for proper timestep-sigma alignment.
Changes from V1:
- Use noise_scheduler.sigmas[indices] to get matching sigmas for timesteps
- Keeps target = (noise - data) from V1
"""
...
def parse_args():
    import argparse
    parser = argparse.ArgumentParser(description="Train Flux LoRA with Redux - V3")
